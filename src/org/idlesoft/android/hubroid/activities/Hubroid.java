...
public class Hubroid extends Activity {
        ...
        try {
            ...
            if (root.canWrite()) {
                ...
                if (image.exists() && image.isFile()) {
                    ...
                    try {
                        id = new JSONObject(new GitHubAPI().user.info(name).resp).getJSONObject(
                                "user").getString("gravatar_id");
    ...
    /**
     * Returns a Bitmap of the Gravatar associated with the provided ID. This image will be scaled
