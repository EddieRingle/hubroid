    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (parts[2].equalsIgnoreCase("github.com")) {
            if (parts.length <= 3) {
                ...
                if (parts[3].equalsIgnoreCase("blog") || parts[3].equalsIgnoreCase("explore")
                        || parts[3].equalsIgnoreCase("languages")
                        || parts[3].equalsIgnoreCase("timeline")
                        || parts[3].equalsIgnoreCase("login") || parts[3].equalsIgnoreCase("inbox")
                        || parts[3].equalsIgnoreCase("repositories")) {
                    /* do nothing */
                } else if (parts[3].equalsIgnoreCase("search")) {
