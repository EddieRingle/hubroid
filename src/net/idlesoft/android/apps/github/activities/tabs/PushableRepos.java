    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case Repositories.CONTEXT_MENU_BRANCHES:
                intent.setClass(PushableRepos.this, BranchesList.class);
                startActivity(intent);
                break;
            case Repositories.CONTEXT_MENU_ISSUES:
                intent.setClass(PushableRepos.this, Issues.class);
                startActivity(intent);
                break;
            case Repositories.CONTEXT_MENU_FORKS:
                intent.setClass(PushableRepos.this, NetworkList.class);
                startActivity(intent);
                break;
            case Repositories.CONTEXT_MENU_OWNER:
                intent.setClass(PushableRepos.this, Profile.class);
